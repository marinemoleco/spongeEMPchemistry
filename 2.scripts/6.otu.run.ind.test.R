...
load("3.results/otu.create.data.output/emp.sum.final.otu.RData")
load("3.results/otu.create.data.output/index/data.index.RData")
load("3.results/otu.create.data.output/index/list.data.RData")
