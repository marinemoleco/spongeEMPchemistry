...
read.table("1.data/shared.raw.data/Metadata_manually_checked3.tsv", sep="\t", header = TRUE, row.names = 1) -> vari.data
...
dir <- "3.results/correlation.variables.output"
dir.create(dir,showWarnings = F)
save(vari.data.combs, file = "3.results/correlation.variables.output/vari.data.combs.RData")
rm(dir)
